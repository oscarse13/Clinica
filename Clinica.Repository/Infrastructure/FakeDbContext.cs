...
namespace Clinica.Repository.Infrastructure
{
    ...
    public abstract class FakeDbContext : IFakeDbContext
    {
        ...
        readonly Dictionary<Type, object> _fakeDbSets;
        ...
        public Task<int> SaveChangesAsync(string username) { return new Task<int>(() => default(int)); }
        public int SaveChanges(string username) { return default(int); }
    }
}