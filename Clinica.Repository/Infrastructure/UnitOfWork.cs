...
namespace Clinica.Repository.Infrastructure
{
    public class UnitOfWork : IUnitOfWorkAsync
    {
        ...
        IDataContextAsync _dataContext;
        bool _disposed;
        ...
        {
            return _dataContext.SaveChanges("Anónimo");
        }

        public int SaveChanges(string username)
        {
            return _dataContext.SaveChanges(username);
        }
        ...
        {
            return _dataContext.SaveChangesAsync("Anónimo");
        }

        public Task<int> SaveChangesAsync(string username)
        {
            return _dataContext.SaveChangesAsync(username);
        }
