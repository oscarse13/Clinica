...
namespace Clinica.Repository.Infrastructure
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
        ...
        readonly IDataContextAsync _context;
        ...
        void SyncObjectGraph(object entity) // scan object graph for all 
        {
        ...
        public IEnumerable<TEntity> Select(Expression<Func<TEntity, bool>> query)
        {
