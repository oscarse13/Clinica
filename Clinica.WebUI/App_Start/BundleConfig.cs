    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/appScripts")
                ...
                .Include("~/Scripts/app/modules/gestionclinica/gestioncitas.module.js")
                .Include("~/Scripts/app/modules/gestionclinica/gestioncitas.controller.js")
                // Custom scripts
                .Include("~/Scripts/app/custom/custom.module.js")
                .Include("~/Scripts/app/modules/pages/pages.module.js")
                 .Include("~/Scripts/app/modules/pages/access-login.controller.js")
                  .Include("~/Scripts/app/modules/pages/access-register.controller.js")
